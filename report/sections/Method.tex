...
\textit{Note: This spatial aggregation is motivated by two considerations: (i) the computational cost of analyzing the full set of tokens would be prohibitive, and (ii) averaging over windows and patches provides a concise, holistic representation of each head's behavior for a given audio sample.}
